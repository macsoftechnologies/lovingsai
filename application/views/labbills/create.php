            ...
            <div class="row">
              <div class="col-12">
                <div class="card">
                  ...
                  <div class="card-body">
          		<form action="<?=base_url()?>labills/insert" role="form" id="userForm" name="userForm" method="post" enctype="multipart/form-data">
          			<div class="form-row">
                        <div id="output"></div>
          				<div class="col-md-3">
                    ...
                    <div class="form-group">
                      <label for="name">Customer Name</label>
                      <input type="text" name="customer_name" id="customer_name" class="form-control" placeholder="Enter customer_name" value="<?php echo $this->input->post('customer_name')?>"><?php echo form_error('customer Name'); ?>
                    </div>
                  </div>
                  ...
                  <div class="col-md-3" id="templates2">
                    <div class="form-group">
                      ...
                      <input type="text" name="phone_number" id="phone_number" class="form-control" placeholder="Enter Phone Number" value="<?php echo $this->input->post('phone_number')?>"><?php echo form_error('phone_number'); ?>
                    </div>
                  </div>
                  ...
                  <div class="col-md-3" id="templates3">
                    <div class="form-group">
                      ...
                      <input type="number" name="age" id="age" class="form-control" placeholder="Enter Age" value="0"><?php echo form_error('age'); ?>
                    </div>
                  </div>
                  ...
                  <div class="col-md-3">
                    <div class="form-group">
                      ...
                      <input type="text" name="total_amount" id="total_amount" class="form-control" placeholder="Enter Amount" value="0" readonly><?php echo form_error('total_amount'); ?>
                    </div>
                  </div>
                                           ...
                                           <div class="table-responsive">
                                               <table id="faqs" class="table table-hover">
                                                   ...
                                                   <tbody>
                                                    ...
                                                    for ($i=0; $i < 6; $i++) { 
                                                    ?>
                                                       <tr id="rowdelete<?php echo $i+1;?>">
                                                           <td> <select class="form-control" name="laboratory_id[]" id="product_id<?php echo $i+1;?>">
                                                           ...
                                                           <td><input type="text" class="form-control" name="price[]" id="price<?php echo $i+1;?>" placeholder="Enter Price..." value="0"></td>
                                                           <td><input type="text" class="form-control" id="discount<?php echo $i+1;?>" name="discount_price[]" placeholder="Enter Discount Price" value="0"></td>
                                                           <td class="mt-10"><a class="badge badge-danger" style="color:#fff;" id="<?php echo $i+1;?>" onclick="$('#rowdelete<?php echo $i+1;?>').hide();"><i class="fa fa-trash"></i> Delete</a></td>
                                                       </tr>
                                                   <?php } ?>
                                                   </tbody>
                                               </table>
