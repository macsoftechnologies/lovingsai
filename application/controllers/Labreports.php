...
class Labreports extends CI_Controller {
...

	{
		...
		$this->settemplate->dashboard("labreports/index",$data);
    }
	...
	public function reports() 
	{
		...
		$data['labbills'] = $this->um->getSearchLabreports("lab_bills", $whr, $from_date, $to_date);

		$this->settemplate->dashboard("labreports/reports",$data);
    }
