...
class Reports extends CI_Controller {
...

	{
        ...
        $data['patient'] = $this->um->getDepartments123("patient",[]);

		$this->settemplate->dashboard("reports/index",$data);
    }
	...
	public function reports() 
	{
        ...
        $data['patientlist'] = $this->um->getDepartments123("patient",[]);
		...
		$data['patient'] = $this->um->getSearchProducts("patient", $patient_id, $whr, $from_date, $to_date);

		$this->settemplate->dashboard("reports/reports",$data);
    }
