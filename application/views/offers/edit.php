            ...
            <div class="row">
              <div class="col-12">
                <div class="card">
                  ...
                  <div class="card-body">
          		<form action="<?=base_url()?>offers/update/<?php echo $offer['offer_id'];?>" role="form" id="userForm" name="userForm" method="post" enctype="multipart/form-data">
          			<div class="form-row">
          				<div class="col-md-4">
          					<div class="form-group">
          						<label for="name">Offer Title</label>
          						<input type="text" name="offer_title" id="name" class="form-control" placeholder="Enter Offer Title" value="<?php echo $offer['offer_title'];?>"><?php echo form_error('offer_title'); ?>
          					</div>
          				</div>
                  ...
                  <div class="col-md-4">
                    <div class="form-group">
                      ...
                      <input type="number" name="offer_amount" id="name" class="form-control" placeholder="Enter Offer Title" value="<?php echo $offer['offer_amount'];?>"><?php echo form_error('offer_amount'); ?>
                    </div>
                  </div>
                  ...
                  <div class="col-md-4">
                    <div class="form-group">
                      <label for="brand">Offer Banner Image</label>
                       <input type="file" name="offer_banner_image" id="offer_banner_image" class="form-control" placeholder="Enter Image" value="<?php echo $offer['offer_banner_image'];?>">
