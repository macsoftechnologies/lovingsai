...
class Salesreports extends CI_Controller {
...

	{
		...
		$this->settemplate->dashboard("salesreports/index",$data);
    }
	...
	public function reports() 
	{
		...
		$data['sales'] = $this->um->getSearchSalesreports("sales", $whr, $from_date, $to_date);

		$this->settemplate->dashboard("salesreports/reports",$data);
    }
