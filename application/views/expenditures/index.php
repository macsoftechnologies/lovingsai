              ...
              <div class="col-12">
                <div class="card">
                  <div class="card-header">
                    <h4>Expenditures</h4>
                      <a href="<?=base_url();?>expenditures/create"  class="btn btn-primary pull-right" style="color:#fff;"><i class="fas fa-plus-circle"></i> Add Expenditures</a>
                  </div>
                  <div class="card-body">
                      ...
                      <table class="table table-striped" id="table-1" >
                        ...
                        <tbody>
                          ...
                          <tr>
                            ...
                            <td class="text-center">
                              <a class="btn btn-primary btn-action" data-toggle="tooltip" title="Edit"  href="<?=base_url();?>expenditures/edit/<?php echo $of->expenditures_id?>">
                                    <i class="fa fa-pencil"></i>
                                </a>
                               
                                <a class="btn btn-danger btn-action" data-toggle="tooltip" title="Delete" onclick="return deleteItem();" href="<?=base_url();?>expenditures/delete/<?php echo $of->expenditures_id?>">
