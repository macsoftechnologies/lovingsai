              ...
              <div class="col-12">
                <div class="card">
                  <div class="card-header">
                    ...
                    <h4>Generate Purchase Report</h4>
                  ...
                  <div class="card-body">
                    <form action="<?=base_url()?>salesreports/reports" role="form" id="userForm2" name="userForm" method="post" enctype="multipart/form-data" class="image-modal-form">
                      ...
                      <table class="table table-striped" id="datatables" style="width: 90%;overflow-x: scroll;">
                        ...
                        <tbody>
                         <?php if($sales->num_rows() > 0) {
                            foreach ($sales->result() as $key => $of) { ?>
                          <tr>
                              
                             <td class="text-center"><?php echo $key+1;?></td>
                             <td><?php echo $of->date;?></td>
                            <td><?php echo $of->patientName;?></td>
                            <td><?php echo $of->InvoiceNo;?></td>
                            <td><?php echo $of->status;?><br><a class="btn btn-warning btn-action" data-toggle="tooltip" title="Edit"  href="<?=base_url();?>sales/view/<?php echo $of->sales_id?>">
                                    <i class="fa fa-eye"></i>
                                </a></td>                              
                          </tr>
