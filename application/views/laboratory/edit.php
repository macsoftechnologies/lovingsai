            ...
            <div class="row">
              <div class="col-12">
                <div class="card">
                  ...
                  <div class="card-body">
              <form action="<?=base_url()?>laboratory/update/<?php echo $laboratory['laboratory_id'];?>" role="form" id="userForm" name="userForm" method="post" enctype="multipart/form-data">
                <div class="form-row">
                  <div class="col-md-4">
                    <div class="form-group">
                      ...
                      <select class="form-control" name="laboratory_type" onchange="yesnoCheck(this);">
                        <option value="<?php echo $laboratory['laboratory_type'];?>"><?php echo $laboratory['laboratory_type'];?></option>
                  ...
                  <div class="col-md-4" id="templates1">
                    <div class="form-group">
                      ...
                      <input type="text" name="test" id="test" class="form-control" placeholder="Enter test" value="<?php echo $laboratory['test'];?>">
                    </div>
                  </div>
                  ...
                  <div class="col-md-4" id="templates2" style="display: none;">
                    <div class="form-group">
                      ...
                      <select class="form-control label ui selection fluid dropdown" name="testdata[]" multiple="">
                         <?php if($laboratorylist->num_rows() > 0) {
                          foreach ($laboratorylist->result() as $key => $lab) { ?>  
                  ...
                  <div class="col-md-4">
                    <div class="form-group">
                      ...
                      <input type="text" name="code" id="test" class="form-control" placeholder="Enter code" value="<?php echo $laboratory['code'];?>"><?php echo form_error('code'); ?>
                    </div>
                  </div>
                  <div class="col-md-4">
                    <div class="form-group">
                      <label for="name">Price</label>
                      <input type="text" name="price" id="test" class="form-control" placeholder="Enter Price" value="<?php echo $laboratory['price'];?>"><?php echo form_error('price'); ?>
                    </div>
                  </div>
                  <div class="col-md-4">
                    <div class="form-group">
                      <label for="name">Discount Price</label>
                      <input type="text" name="discount" id="test" class="form-control" placeholder="Enter Discount" value="<?php echo $laboratory['discount'];?>"><?php echo form_error('discount'); ?>
                    </div>
                  </div>
