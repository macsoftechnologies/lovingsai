            ...
            <div class="row">
              <div class="col-12">
                <div class="card">
                  ...
                  <div class="card-body">
                    <form action="<?=base_url()?>labreports/reports" role="form" id="userForm2" name="userForm" method="post" enctype="multipart/form-data" class="image-modal-form">
                      ...
                      <table class="table table-striped" id="datatables" style="width: 90%;overflow-x: scroll;">
                        ...
                        <tbody>
                          ...
                          <tr>
                            ...
                            <td><?php echo $of->total_amount;?><br><a class="btn btn-warning btn-action" data-toggle="tooltip" title="Edit"  href="<?=base_url();?>labills/view/<?php echo $of->lab_bills_id?>">
                                    <i class="fa fa-eye"></i>
                                </a></td>
