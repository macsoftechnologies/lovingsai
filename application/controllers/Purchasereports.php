...
class Purchasereports extends CI_Controller {
...

	{
		...
		$this->settemplate->dashboard("purchasereports/index",$data);
    }
	...
	public function reports() 
	{
		...
		$data['purchase'] = $this->um->getSearchPurchasereports("purchase", $whr, $from_date, $to_date);

		$this->settemplate->dashboard("purchasereports/reports",$data);
    }
