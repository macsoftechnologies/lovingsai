          ...
          <div class="section-body">
            <div class="row">
              ...
              <!--  <div class="card-header">
                  ...
                  <!-- </div> -->
                  <div class="card-body">
              <form action="<?=base_url()?>presciption/update/<?php echo $presciption_id;?>" role="form" id="userForm" name="userForm" method="post" enctype="multipart/form-data">
                <div class="form-row">
                ...
                <div class="col-md-3">
                     <div class="form-group">
                      ...
                      <textarea type="text" name="provisionalDiagnosis" id="provisionalDiagnosis" class="form-control" placeholder="Enter provisionalDiagnosis"><?php echo form_error('provisionalDiagnosis'); ?><?php echo $presciptions['provisional_diagnostics'];?></textarea>
                    </div>
                </div>
                ...
                <div class="col-md-3">
                   <div class="form-group">
                      ...
                      <textarea type="text" name="note1" id="note1" class="form-control" value="<?php echo $presciptions['note1'];?>"><?php echo $presciptions['note1'];?></textarea>
                      <!-- <textarea name="note1" id="note1" class="form-control" placeholder="Enter Description"><?php echo $presciptions['note1'];?></textarea><?php echo form_error('note1'); ?> -->
                    </div>
                </div>
                ...
                <div class="col-md-3 textarea-box">
                    <div class="form-group">
                      ...
                      <textarea name="note2" id="note2" class="form-control text-boxx" placeholder="Enter Description"><?php echo $presciptions['note2'];?></textarea><?php echo form_error('note2'); ?>
                    </div>
                </div>
                                                   ...
                                                   <tbody>
                                                    <?php if($medicines->num_rows() > 0) {
                                                       ...
                                                       <tr class="select-med-padding" id="deleteitem<?php echo $md->medicine_id;?>">
                                                           <td >  <input list=text_editors style="width:310px; height: 50px;" name="medicine_id[]" value="<?php echo $md->medicine_name;?>">
<!-- <button>▼</button> -->
                                                           ...
                                                           <td>
                                                            ...
                                                            <input type="text" name="morning[]" class="checkbox1 form-control gaps" value="<?php echo $md->morning;?>" style="font-size: 25px;">
                                                           </td>
                                                           <td>
                                                            ...
                                                            <input type="text" style="font-size:25px;" name="afternoon[]" class="checkbox2 form-control gaps" value="<?php echo $md->afternoon;?>" >
                                                           </td>
                                                           <td>
                                                            <?php if($md->night == 0) {
                                                                    $ngf = '';
                                                            ...
                                                            <input type="text" style="font-size:25px;" name="night[]" class="checkbox3 form-control gaps" value="<?php echo $md->night;?>" >
                                                           </td>
                                                           <td>
                                                            ...
                                                            <input type="checkbox" name="afted[]" class="checkbox4 form-control morning-input<?php echo $key+1;?>" value="<?php echo $md->after_food;?>" style="font-size: 25px;margin-left: 6px" <?php echo $aftr;?>>
                                                           ...
                                                           <td>
                                                            ...
                                                            <input type="checkbox" name="beforfood[]" class="checkbox5 form-control morning-input<?php echo $key+1;?>"value="<?php echo $md->before_food;?>" style="font-size: 25px;" <?php echo $bftr;?>>
                                                            <input type="hidden" name="before_food[]"  id="output5<?php echo $key+1;?>" value="<?php echo $md->before_food;?>">
                                                           </td>
                                                           <td><input type="number" name="no_of_days[]" value="<?php echo $md->no_of_days;?>"style="height: 50px;width: 65px;"></td>
                      ...
                      <input type="date" name="review_date" class="form-control" value="<?php echo $presciptions['review_date'];?>">
                    </div>
...
html = '<tr id="faqs-row' + faqs_row + '" class="select-med-padding">';
   ...
   html += '<td><input type="text" id=mor'+faqs_row+' value="0"   class="largerCheckbox'+faqs_row+' form-control" name="morning[]" style="font-size: 25px;"> </td>';
    html += '<td><input type="text" id=afr'+faqs_row+' value="0"   class="largerCheckbox'+faqs_row+' form-control" name="afternoon[]" style="font-size: 25px;"> </td>';
                     ...
                     $('#patientinformation').show();
                      ...
                      if(result['medicines'] == 0) {
                        ...
                        $.each(result['list'], function (k, v) {
                            ...
                            msg += '<tr id="faqs-row' + faqs_row + '"><td><select class="form-control select2 year chosen-select" name="medicine_id[]" ><option value="'+v.medicine_id+'">'+v.name+'</option><?php if($medicine->num_rows() > 0){foreach ($medicine->result() as $pa) { ?><option value="<?php echo $pa->medicine_id;?>"><?php echo $pa->name;?></option><?php }}?></select></td><td><input type="checkbox" id=row'+faqs_row+' value="'+v.morning+'"name="mor[]" '+mof+'> <input type="hidden" class=t'+faqs_row+' value="'+v.morning+'"name="morning[]"></td><td><input type="checkbox" id=afr'+faqs_row+' value="'+v.afternoon+'" name="aft[]" '+aof+'> <input type="hidden" class=a'+faqs_row+' value="'+v.afternoon+'" name="afternoon[]"></td><td><input type="checkbox" id=ngt'+faqs_row+' value="'+v.night+'" name="nig[]" '+nof+'> <input type="hidden" class=n'+faqs_row+' value="'+v.night+'" name="night[]"></td><td><input type="checkbox" id=afrfd'+faqs_row+' value="'+v.after_food+'" name="aftd[]" '+aff+'> <input type="hidden" class=f'+faqs_row+' value="'+v.after_food+'" name="after_food[]"></td><td><input type="checkbox" id=ngtfd'+faqs_row+' value="'+v.before_food+'" name="befd[]" '+bef+'> <input type="hidden" class=g'+faqs_row+' value="'+v.before_food+'" name="before_food[]"></td><td><input type="number" class="form-control" name="no_of_days[]" value="'+v.no_of_days+'" style="width:100px;"></td><td class="mt-10"><a class="badge badge-danger" style="color: #fff;" onclick="$(\'#faqs-row' + faqs_row + '\').remove();"><i class="fa fa-trash"></i> Delete</a></td>';
                        });
