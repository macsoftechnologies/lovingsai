...
<body style="background-image: url(<?=base_url();?>assets1/img/login-bg-new.png); background-size: cover;">
          ...
          <div class="col-12 col-sm-8 offset-sm-2 col-md-6 offset-md-3 col-lg-6 offset-lg-3 col-xl-4 offset-xl-4">
            ...
            <div class="card card-primary">
              <div class="card-header">
                ...
                <img alt="image" src="<?=base_url();?>assets/lovingsai.jpg" class="" style="height: 80px;">
                <h4 style="margin-top: 40px;float: right; font-size: 25px;">Loving Sai Clinic</h4>
                
              </div>
              <div class="card-body">
                <form method="POST" action="<?=base_url()?>adminlogin/login" class="needs-validation" novalidate="">
