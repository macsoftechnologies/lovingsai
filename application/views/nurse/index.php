              ...
              <div class="col-12">
                <div class="card">
                  <div class="card-header">
                    <h4>Nurse</h4>
                      <!-- <a href="<?=base_url();?>nurse/create"  class="btn btn-primary pull-right" style="color:#fff;"><i class="fas fa-plus-circle"></i> New  </a> -->
                  </div>
                  <div class="card-body">
                    <div class="" style="width: 100%;overflow-x: scroll;">
                      <table class="table table-striped" id="table-1" >
                        ...
                        <tbody>
                          <?php if($nurse->num_rows() > 0) {
                            foreach ($nurse->result() as $key => $of) { ?>
                          <tr>
                            ...
                            <td class="text-center">
                            <!--   <a class="btn btn-primary btn-action" data-toggle="tooltip" title="Edit"  href="<?=base_url();?>nurse/edit/<?php echo $of->nurse_id?>">
                                    <i class="fa fa-pencil"></i>
                                </a>
                               
                                <a class="btn btn-danger btn-action" data-toggle="tooltip" title="Delete" onclick="return deleteItem();" href="<?=base_url();?>nurse/delete/<?php echo $of->nurse_id?>">
              ...
              <div class="modal-dialog">
                <div class="modal-content photo-modal data-modal">
                  ...
                  <div class="modal-body">
                    <div class="add-photo">
                       <form action="<?=base_url()?>nurse/insert" role="form" id="userForm2" name="userForm" method="post" enctype="multipart/form-data" class="image-modal-form">
                        <div class="col-md-12">
                          <div class="row">
