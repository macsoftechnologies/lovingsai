            ...
            <div class="row">
              <div class="col-12">
                <div class="card">
                  ...
                  <div class="card-body">
          		<form action="<?=base_url()?>department/insert" role="form" id="userForm" name="userForm" method="post" enctype="multipart/form-data">
          			<div class="form-row">
          				<div class="col-md-4">
          					<div class="form-group">
          						<label for="name">name</label>
          						<input type="text" name="name" id="name" class="form-control" placeholder="Enter Department name " value="<?php echo $this->input->post('name')?>"><?php echo form_error('name'); ?>
          					</div>
          				</div>
                  ...
                  <!-- <div class="col-md-4">
                    <div class="form-group">
                      ...
                      <input type="number" name="description" id="name" class="form-control" placeholder="Enter description" value="<?php echo $this->input->post('description')?>"><?php echo form_error('desc'); ?>
                    </div>
                  </div> -->
