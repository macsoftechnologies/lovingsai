              ...
              <div class="col-12">
                <div class="card">
                  <div class="card-header">
                    <h4>Laboratorist</h4>
                      <!-- <a href="<?=base_url();?>laboratorist/create"  class="btn btn-primary pull-right" style="color:#fff;"><i class="fas fa-plus-circle"></i> New  </a> -->
                  </div>
                  <div class="card-body">
                    <div class="" style="width: 100%;overflow-x: scroll;">
                      <table class="table table-striped" id="table-1" >
                        ...
                        <tbody>
                          <?php if($laboratorist->num_rows() > 0) {
                            foreach ($laboratorist->result() as $key => $of) { ?>
                          <tr>
                            ...
                            <td class="text-center">
                            <!--   <a class="btn btn-primary btn-action" data-toggle="tooltip" title="Edit"  href="<?=base_url();?>laboratorist/edit/<?php echo $of->laboratorist_id?>">
                                    <i class="fa fa-pencil"></i>
                                </a> -->
                               
                              <!--   <a class="btn btn-danger btn-action" data-toggle="tooltip" title="Delete" onclick="return deleteItem();" href="<?=base_url();?>laboratorist/delete/<?php echo $of->laboratorist_id?>">
