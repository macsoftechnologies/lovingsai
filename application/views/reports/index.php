            ...
            <div class="row">
              <div class="col-12">
                <div class="card">
                  ...
                  <div class="card-body">
                    <form action="<?=base_url()?>reports/reports" role="form" id="userForm2" name="userForm" method="post" enctype="multipart/form-data" class="image-modal-form">
                      ...
                      <option value="">Select Patient</option>
                            ...
                            <div class="col-md-3 col-xs-12" >
                              <div class="form-group">
                                ...
                                <label>From Date</label>
                                 <input type="date" name="from_date" class="form-control declaration" placeholder="Enter From Date" id="declaration" >
                            ...
                            <div class="col-md-3 col-xs-12" >
                              <div class="form-group">
                                <!-- <input type="text" name="declaration" class="form-control" placeholder="Enter Declaration" > -->
                                <label>To Date</label>
                                 <input type="date" name="to_date" class="form-control declaration" placeholder="Enter To Date" id="declaration" >
                               <!--  <textarea class="form-control" name="about_me" size="100" placeholder="About Me"></textarea> -->
                                </div>
                            </div>
                  ...
                  <div class="card-header">
                    ...
                    <h6 style="text-align: end;">Patients Count <a href="#" class="btn btn-success btn-xs"><?php echo $patient->num_rows();?></a></h6>
                  </div>
                      ...
                      <table class="table table-striped" id="datatables" style="width: 90%;overflow-x: scroll;">
                        ...
                        <tbody>
                          ...
                          <tr>
                            ...
                            <td>
                              <?php 
                                  $presciption123 = $this->db->query("SELECT * FROM `doctor_prescription` WHERE patient_id = '".$of->patient_id."' ORDER BY presciption_id DESC")->row_array();
                              ?>
                               <?php if($presciption123 == '') {?>
                                <?php }else { ?>
                                <?php echo date('d-m-Y',strtotime($presciption123['review_date']));?>
                              <?php } ?>
                            </td>
                            <td><?php echo $of->phone;?><br><?php 
                                  $presciption = $this->db->query("SELECT * FROM `doctor_prescription` WHERE patient_id = '".$of->patient_id."' ORDER BY presciption_id DESC")->row_array();
                              ?>
                                <?php if($presciption == '') {?>
                                <?php }else { ?>
                                  <a class="btn btn-warning btn-action" data-toggle="tooltip" title="Edit"  href="<?=base_url();?>presciption/view/<?php echo $of->patient_id?>">
                                    <i class="fa fa-eye"></i>
                                </a>
                                <?php } ?></td>
